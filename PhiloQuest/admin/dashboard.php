    ...
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm rounded-4 h-100">
            <div class="card-body p-4">
                ...
                <a href="gerenciar_usuarios.php" class="btn btn-outline-secondary philo-btn-action w-100 mb-2 d-flex align-items-center gap-2 justify-content-start">
                ...
                <a href="cadastrar_professor.php" class="btn btn-outline-secondary philo-btn-action w-100 d-flex align-items-center gap-2 justify-content-start">
                    <i class="fas fa-chalkboard-teacher text-primary"></i> Cadastrar Novo Professor
                </a>
            </div>
        </div>
    </div>
